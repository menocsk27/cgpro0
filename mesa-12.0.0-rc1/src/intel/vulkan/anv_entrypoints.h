...
struct anv_dispatch_table {
   union {
      ...
      struct {
         ...
         VkResult (*CreateDmaBufImageINTEL)(VkDevice device, const VkDmaBufImageCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMem, VkImage* pImage);
      };
