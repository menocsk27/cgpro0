...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_893)(GLuint program, GLenum programInterface, GLenum pname, GLint *params);
GLuint APIENTRY GLAPI_PREFIX(_dispatch_stub_894)(GLuint program, GLenum programInterface, const GLchar *name);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_897)(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei *length, GLchar *name);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_898)(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei bufSize, GLsizei *length, GLint *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_920)(GLuint framebuffer, GLenum buffer, GLfloat depth, GLint stencil);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1040)(GLuint pipeline, GLuint program);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1041)(GLuint pipeline);
GLuint APIENTRY GLAPI_PREFIX(_dispatch_stub_1042)(GLenum type, GLsizei count, const GLchar * const *strings);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1043)(GLsizei n, const GLuint *pipelines);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1044)(GLsizei n, GLuint *pipelines);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1045)(GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1046)(GLuint pipeline, GLenum pname, GLint *params);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_1047)(GLuint pipeline);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1051)(GLuint program, GLint location, GLfloat x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1052)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1053)(GLuint program, GLint location, GLint x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1054)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1055)(GLuint program, GLint location, GLuint x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1056)(GLuint program, GLint location, GLsizei count, const GLuint *value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1059)(GLuint program, GLint location, GLfloat x, GLfloat y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1060)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1061)(GLuint program, GLint location, GLint x, GLint y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1062)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1063)(GLuint program, GLint location, GLuint x, GLuint y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1064)(GLuint program, GLint location, GLsizei count, const GLuint *value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1067)(GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1068)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1069)(GLuint program, GLint location, GLint x, GLint y, GLint z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1070)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1071)(GLuint program, GLint location, GLuint x, GLuint y, GLuint z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1072)(GLuint program, GLint location, GLsizei count, const GLuint *value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1075)(GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1076)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1077)(GLuint program, GLint location, GLint x, GLint y, GLint z, GLint w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1078)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1079)(GLuint program, GLint location, GLuint x, GLuint y, GLuint z, GLuint w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1080)(GLuint program, GLint location, GLsizei count, const GLuint *value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1096)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1098)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
GLAPI void APIENTRY GLAPI_PREFIX(UnlockArraysEXT)(void);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1100)(GLuint pipeline, GLbitfield stages, GLuint program);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1101)(GLuint pipeline);
